...
public class PSWebTabbedPaneUI extends BasicTabbedPaneUI implements ShapeProvider, BorderMethods
{
    ...
    private boolean paintOnlyTopBorder = false;// WebTabbedPaneStyle.paintOnlyTopBorder;
